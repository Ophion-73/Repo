...
Shader "Custom/PurpleJellyShader"
{
    Properties
    {
        _JellyColor("Jelly Color", Color) = (0.6, 0.2, 0.9, 0.6)
        _ShineColor("Shine Color", Color) = (1, 1, 1, 1)
        _ShineStrength("Shine Strength", Float) = 1.5
        _JellyWobble("Jelly Wobble", Float) = 0.015
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert(appdata v)
            {
                ...
                v.vertex.y += sin(v.uv.x * 8.0 + t) * _JellyWobble;
                v.vertex.x += cos(v.uv.y * 8.0 + t) * _JellyWobble;
