Shader "Unlit/Ventana"
{
    Properties
    {
        _Color ("Base Color", Color) = (0.9, 0.9, 0.9, 1)  // Color de la ventana (gris claro)
        _ShineStrength ("Shine Strength", Range(0, 1)) = 0.2  // Intensidad del brillo
    }
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(Varyings i) : SV_Target
            {
                ...
                // Aplicamos el color de la ventana
